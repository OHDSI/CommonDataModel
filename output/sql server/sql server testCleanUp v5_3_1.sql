...
ALTER TABLE ohdsi.dbo.VISIT_OCCURRENCE DROP CONSTRAINT fpk_VISIT_OCCURRENCE_admitting_source_concept_id ;
...
ALTER TABLE ohdsi.dbo.DEATH DROP CONSTRAINT fpk_DEATH_person_id ;

ALTER TABLE ohdsi.dbo.DEATH DROP CONSTRAINT fpk_DEATH_death_type_concept_id ;

ALTER TABLE ohdsi.dbo.DEATH DROP CONSTRAINT fpk_DEATH_cause_concept_id ;

ALTER TABLE ohdsi.dbo.DEATH DROP CONSTRAINT fpk_DEATH_cause_source_concept_id ;
...
IF OBJECT_ID('ohdsi.dbo.death', 'U') IS NOT NULL  DROP TABLE ohdsi.dbo.death;
