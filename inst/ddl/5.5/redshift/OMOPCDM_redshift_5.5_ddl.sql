--redshift CDM DDL Specification for OMOP Common Data Model 5.5
...
DISTKEY(person_id)
INTERLEAVED SORTKEY(visit_detail_concept_id,person_id);
...
DISTKEY(person_id)
INTERLEAVED SORTKEY(condition_concept_id,person_id);
...
DISTKEY(person_id)
INTERLEAVED SORTKEY(drug_concept_id,person_id);
...
DISTKEY(person_id)
INTERLEAVED SORTKEY(procedure_concept_id,person_id);
...
DISTKEY(person_id)
INTERLEAVED SORTKEY(device_concept_id,person_id);
--HINT DISTRIBUTE_ON_KEY(person_id) 
...
DISTKEY(person_id)
INTERLEAVED SORTKEY(observation_concept_id,person_id);
--HINT DISTRIBUTE_ON_KEY(person_id) 
