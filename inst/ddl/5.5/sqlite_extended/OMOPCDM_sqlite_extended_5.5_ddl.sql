--sqlite extended CDM DDL Specification for OMOP Common Data Model 5.5
...
CREATE TABLE @cdmDatabaseSchema.cdm_source (
			...
			source_release_version TEXT NULL,
...
CREATE TABLE @cdmDatabaseSchema.concept_metadata (
			...
			concept_category TEXT NULL,
			reuse_status TEXT NULL );
CREATE TABLE @cdmDatabaseSchema.concept_relationship_metadata (
			concept_id_1 integer NOT NULL,
			concept_id_2 integer NOT NULL,
			relationship_id TEXT NOT NULL,
			relationship_predicate_id TEXT NULL,
