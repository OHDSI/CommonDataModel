...
ALTER TABLE ohdsi.dbo.episode ADD CONSTRAINT episode_pk PRIMARY KEY NONCLUSTERED ( episode_id);

ALTER TABLE ohdsi.dbo.episode_event ADD CONSTRAINT episode_event_pk PRIMARY KEY NONCLUSTERED ( episode_id, event_id, event_field_concept_id );
