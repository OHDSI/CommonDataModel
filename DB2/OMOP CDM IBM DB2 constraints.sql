...
IBM DB2 script to create foreign key, unique, and check constraints within the OMOP common data model, version 6.0
...
ALTER TABLE VOCABULARY ADD CONSTRAINT PK_VOCABULARY PRIMARY KEY (VOCABULARY_ID);
ALTER TABLE DOMAIN ADD CONSTRAINT PK_DOMAIN PRIMARY KEY (DOMAIN_ID);
ALTER TABLE CONCEPT_CLASS ADD CONSTRAINT PK_CONCEPT_CLASS PRIMARY KEY (CONCEPT_CLASS_ID);
--ALTER TABLE CONCEPT_RELATIONSHIP ADD CONSTRAINT PK_CONCEPT_RELATIONSHIP PRIMARY KEY (RELATIONSHIP_ID);
ALTER TABLE RELATIONSHIP ADD CONSTRAINT PK_RELATIONSHIP PRIMARY KEY (RELATIONSHIP_ID);
--ALTER TABLE CONCEPT_SYNONYM ADD CONSTRAINT PK_CONCEPT_SYNONYM PRIMARY KEY (CONCEPT_ID);
--ALTER TABLE CONCEPT_ANCESTOR ADD CONSTRAINT PK_CONCEPT_ANCESTOR PRIMARY KEY (CONCEPT_ANCESTOR_ID);
--ALTER TABLE SOURCE_TO_CONCEPT_MAP ADD CONSTRAINT PK_SOURCE_TO_CONCEPT_MAP PRIMARY KEY (SOURCE_TO_CONCEPT_MAP_ID);
--ALTER TABLE DRUG_STRENGTH ADD CONSTRAINT PK_DRUG_STRENGTH PRIMARY KEY (DRUG_STRENGTH_ID);
--ALTER TABLE CDM_SOURCE ADD CONSTRAINT PK_CDM_SOURCE PRIMARY KEY (CDM_SOURCE_ID);
--ALTER TABLE METADATA ADD CONSTRAINT PK_METADATA PRIMARY KEY (METADATA_ID);
ALTER TABLE PERSON ADD CONSTRAINT PK_PERSON PRIMARY KEY (PERSON_ID);
ALTER TABLE OBSERVATION_PERIOD ADD CONSTRAINT PK_OBSERVATION_PERIOD PRIMARY KEY (OBSERVATION_PERIOD_ID);
ALTER TABLE SPECIMEN ADD CONSTRAINT PK_SPECIMEN PRIMARY KEY (SPECIMEN_ID);
ALTER TABLE VISIT_OCCURRENCE ADD CONSTRAINT PK_VISIT_OCCURRENCE PRIMARY KEY (VISIT_OCCURRENCE_ID);
ALTER TABLE VISIT_DETAIL ADD CONSTRAINT PK_VISIT_DETAIL PRIMARY KEY (VISIT_DETAIL_ID);
ALTER TABLE PROCEDURE_OCCURRENCE ADD CONSTRAINT PK_PROCEDURE_OCCURRENCE PRIMARY KEY (PROCEDURE_OCCURRENCE_ID);
ALTER TABLE DRUG_EXPOSURE ADD CONSTRAINT PK_DRUG_EXPOSURE PRIMARY KEY (DRUG_EXPOSURE_ID);
ALTER TABLE DEVICE_EXPOSURE ADD CONSTRAINT PK_DEVICE_EXPOSURE PRIMARY KEY (DEVICE_EXPOSURE_ID);
...
ALTER TABLE NOTE ADD CONSTRAINT PK_NOTE PRIMARY KEY (NOTE_ID);
ALTER TABLE NOTE_NLP ADD CONSTRAINT PK_NOTE_NLP PRIMARY KEY (NOTE_NLP_ID);
ALTER TABLE OBSERVATION ADD CONSTRAINT PK_OBSERVATION PRIMARY KEY (OBSERVATION_ID);
ALTER TABLE SURVEY_CONDUCT ADD CONSTRAINT PK_SURVEY_CONDUCT PRIMARY KEY (SURVEY_CONDUCT_ID);
--ALTER TABLE FACT_RELATIONSHIP ADD CONSTRAINT PK_FACT_RELATIONSHIP PRIMARY KEY (FACT_RELATIONSHIP_ID);
ALTER TABLE LOCATION ADD CONSTRAINT PK_LOCATION PRIMARY KEY (LOCATION_ID);
ALTER TABLE LOCATION_HISTORY ADD CONSTRAINT PK_LOCATION_HISTORY PRIMARY KEY (LOCATION_HISTORY_ID);
ALTER TABLE CARE_SITE ADD CONSTRAINT PK_CARE_SITE PRIMARY KEY (CARE_SITE_ID);
ALTER TABLE PROVIDER ADD CONSTRAINT PK_PROVIDER PRIMARY KEY (PROVIDER_ID);
ALTER TABLE PAYER_PLAN_PERIOD ADD CONSTRAINT PK_PAYER_PLAN_PERIOD PRIMARY KEY (PAYER_PLAN_PERIOD_ID);
ALTER TABLE COST ADD CONSTRAINT PK_COST PRIMARY KEY (COST_ID);
ALTER TABLE DRUG_ERA ADD CONSTRAINT PK_DRUG_ERA PRIMARY KEY (DRUG_ERA_ID);
ALTER TABLE DOSE_ERA ADD CONSTRAINT PK_DOSE_ERA PRIMARY KEY (DOSE_ERA_ID);
ALTER TABLE CONDITION_ERA ADD CONSTRAINT PK_CONDITION_ERA PRIMARY KEY (CONDITION_ERA_ID);
